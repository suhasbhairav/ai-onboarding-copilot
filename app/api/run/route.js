...
const SYSTEM_PROMPT = `
You are AI Onboarding Copilot, a focused AI starter template.
...
function offlineResult(prompt) {
  return `
AI Onboarding Copilot offline demo

User input:
${prompt}

Structured output:
1. Goal: Turn the request into a production-ready ai copilot template workflow.
